...
object DataGenerator {
  ...
  def get2DSchema( hsbcTradeId : String , tradeId : String,bookId : String, valuationDt : String) : List[String] = {
    var dataListBuffer = new ListBuffer[String]()


    for(riskType <- riskType2DList ){
      val valueMap = Map("RISK_TYPE" -> riskType, "HSBC_TRADE_ID" -> hsbcTradeId, "BOOK_ID" -> bookId, "VALUATION_DATE" -> valuationDt,
        "MEASURE_VALUE_1" -> r.nextFloat().toString, "MEASURE_VALUE_2" -> r.nextFloat().toString, "MEASURE_VALUE_3" -> r.nextFloat().toString,
        "MEASURE_VALUE_4" -> r.nextFloat().toString, "MEASURE_VALUE_5" -> r.nextFloat().toString, "MEASURE_VALUE_6" -> r.nextFloat().toString,
        "MEASURE_VALUE_7" -> r.nextFloat().toString , "MEASURE_VALUE_8" -> r.nextFloat().toString, "MEASURE_VALUE_9" -> r.nextFloat().toString,
        "MEASURE_VALUE_10" -> r.nextFloat().toString, "MEASURE_VALUE_11" -> r.nextFloat().toString, "MEASURE_VALUE_12" -> r.nextFloat().toString,
        "MEASURE_VALUE_13" -> r.nextFloat().toString)
  ...
  def getScalarSchema( hsbcTradeId : String , tradeId : String, bookId : String, valuationDt : String) : List[String] = {
    var dataListBuffer = new ListBuffer[String]()
  ...
  def get1DSchema( hsbcTradeId : String , tradeId : String, bookId : String, valuationDt : String) : List[String] = {
    var dataListBuffer = new ListBuffer[String]()

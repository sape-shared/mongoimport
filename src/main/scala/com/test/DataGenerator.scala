...
object DataGenerator {
  ...
  def getSchema(hsbcTradeId : String , tradeId : String, bookId : String, valuationDt : String) : List[String] = {
    ...
    val valid_from = valuationDt+"120000"
    getScalarSchema(hsbcTradeId, tradeId,bookId, valuationDt, measure_value,valid_from) :::
      get1DSchema(hsbcTradeId, tradeId,bookId, valuationDt, measure_value,valid_from) :::
      get2DSchema(hsbcTradeId, tradeId,bookId, valuationDt, measure_value,valid_from)
  }

  def get2DSchema( hsbcTradeId : String , tradeId : String,bookId : String, valuationDt : String, measure_value : String,valid_from : String) : List[String] = {
    ...
    for(riskType <- riskType2DList ){
      val valueMap = Map("RISK_TYPE" -> riskType, "HSBC_TRADE_ID" -> hsbcTradeId, "BOOK_ID" -> bookId, "VALUATION_DATE" -> valuationDt,"TRADE_ID" -> tradeId,
        ...
        "MEASURE_VALUE_13" -> measure_value, "VALID_FROM" -> valid_from)
  ...
  def getScalarSchema( hsbcTradeId : String , tradeId : String, bookId : String, valuationDt : String, measure_value : String, valid_from : String) : List[String] = {
    var dataListBuffer = new ListBuffer[String]()
  ...
  def get1DSchema( hsbcTradeId : String , tradeId : String, bookId : String, valuationDt : String, measure_value : String, valid_from : String) : List[String] = {
    var dataListBuffer = new ListBuffer[String]()
